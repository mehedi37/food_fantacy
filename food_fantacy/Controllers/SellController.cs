...
namespace food_fantacy.Controllers
{
    ...
    public class SellController : Controller
    {
        ...
        {
            var userId = User.FindFirstValue(ClaimTypes.NameIdentifier);
            return View(new ProductsDetails
            {
                ProductId = new int(),
        ...
        [HttpPost]
        public async Task<IActionResult> AddNewFood(ProductsDetails product)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> EditFood(ProductsDetails product)
        {
            if (ModelState.IsValid)
            {
