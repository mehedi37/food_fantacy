        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductsDetails_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItemsDetails", x => x.CartDetailsId);
                    table.ForeignKey(
                        name: "FK_CartItemsDetails_Cart_CartId",
                        column: x => x.CartId,
                        principalTable: "Cart",
                        principalColumn: "CartId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItemsDetails_ProductsDetails_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItemsDetails_CartId",
                table: "CartItemsDetails",
                column: "CartId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItemsDetails_ProductId",
                table: "CartItemsDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsDetails_UserId",
